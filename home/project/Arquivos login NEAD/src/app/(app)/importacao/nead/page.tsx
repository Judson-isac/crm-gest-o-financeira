...
function ExtractedDataDisplay({ extractedData }: { extractedData: ExtractedDataState }) {
    ...
    return (
        <Card className="w-full mt-6 animate-in fade-in-50">
            <CardHeader>
                 <CardTitle>Dados Extraídos para Importação</CardTitle>
                 <CardDescription>
    ...
    <div className="flex flex-col items-center p-4 sm:p-8 md:p-12 gap-6">
      ...
      <div className="w-full max-w-5xl">
        <Card className="w-full shadow-lg">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <form action={fetchFormAction} className="space-y-4">
        ...
        <div className="w-full max-w-5xl">
            <Card className="w-full shadow-lg">
                <CardHeader>
                    <CardTitle className="font-headline text-2xl flex items-center gap-2"><Bot />3. Extração e Importação</CardTitle>
                    <CardDescription>Inicie a análise do relatório para extrair os dados e prepará-los para importação.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Button onClick={handleStartParsing} disabled={isParsing || !fetchState.success || !fetchState.html}>
