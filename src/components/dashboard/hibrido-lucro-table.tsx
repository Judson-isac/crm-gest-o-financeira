...
export function HibridoLucroTable({ data, onRemove }: WidgetProps) {
    ...
    <Card className="h-full grid grid-rows-[auto_1fr]">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <div className="drag-handle cursor-move">
            <CardTitle className="text-base">Tabela: Lucro Cursos Híbridos</CardTitle>
            <CardDescription className="text-xs">Repasse de Cursos Híbridos - Despesa Proporcional</CardDescription>
        </div>
            ...
            <Table>
                 <TableHeader className="sticky top-0 bg-card z-10">
                    <TableRow>
                        ...
                        <TableHead className="text-right">Repasse Híbrido</TableHead>
                        <TableHead className="text-right">Despesa (Alocada)</TableHead>
                        <TableHead className="text-right">Lucro Híbrido</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
