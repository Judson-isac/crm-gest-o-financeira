...
export function LucroCursoHibridoTable({ data, onRemove }: WidgetProps) {
    const tableData = data.filter(item => item.metodologia === 'HIBRIDO');
    ...
    <Card className="h-full grid grid-rows-[auto_1fr]">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <div className="drag-handle cursor-move">
            <CardTitle className="text-base">Tabela: Lucro por Curso Híbrido</CardTitle>
