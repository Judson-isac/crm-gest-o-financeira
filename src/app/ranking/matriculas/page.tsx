...
export default function RankingPage() {
    ...
    const getPodiumColor = (pos: number) => {
        if (pos === 1) return 'text-yellow-400 bg-yellow-400/10 border-yellow-400/50';
        if (pos === 2) return 'text-gray-300 bg-gray-300/10 border-gray-300/50';
        if (pos === 3) return 'text-amber-600 bg-amber-600/10 border-amber-600/50';
